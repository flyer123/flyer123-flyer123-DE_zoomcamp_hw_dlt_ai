...
@dlt.source
def tax_pipeline_rest_api_source(access_token: str = dlt.secrets.value):
...
pipeline = dlt.pipeline(
    pipeline_name='tax_pipeline_pipeline',
    destination='duckdb',
...
if __name__ == "__main__":
    load_info = pipeline.run(tax_pipeline_rest_api_source())
